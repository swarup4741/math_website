...
export default function Research(){
    ...
    const paper_list = [
        ...
        },
        {
            ...
            note: "This is still a work in progress as the current version contains a crucial mistake in the example of exotic disks (pointed out Kyle Hayden) and we are also working on severely improving the description of the differential."
        }
