  ...
  return (
    <div className="px-1 md:px-6 lg:px-10">
      ...
      <li className="mb-5">
        ...
        <li className="mb-5">
          Contributory talk - <strong>Khovanov homology and exotic discs</strong>. <Link className="text-blue-500" href="https://rms2024.christuniversity.in/" target="_blank">RMS 2024</Link>
        </li>
        <li className="mb-5">
        ...
        <li className="mb-5">
         <Link href="https://www.ncngt.org/" target="=_blank" className="text-blue-500">The Nearly Carbon Neutral Geometric Topology Conference 2023</Link>
        </li>
      </ul>
    </div>
  );
