    ...
    <div className="px-1 md:10px md:py-5">
      <div className="flex flex-col lg:flex-row lg:justify-around lg:align-middle">
        <div className="lg:mr-10">
          <h1 className="subpixel-antialiased text-3xl md:text-4xl lg:text-5xl mb-10 mt-5">
            Swarup Kumar Das
          </h1>
          <p className="subpixel-antialiased md:text-lg lg:text-lg mb-5">
          ...
          <p className="subpixel-antialiased md:text-lg lg:text-lg mb-5">
            My research interest lies in the study of invariants like
            Khovanov homology, Heegard Floer homology and other invariants
            arising from these theories to study knots/links, 3-manifolds,
            4-manifolds and interactions between them.
          </p>
          <p className="subpixel-antialiased md:text-lg lg:text-lg">
            I completed my Masters in Mathematics from{" "}
            <Link
              className="text-blue-500"
              href="https://maths.rkmvu.ac.in/"
              target="_blank"
            >
              Ramakrishna Mission Vivekananda Educational Research Institute
            </Link>{" "}
            (2022) and did my Bachelors in Mathematics from{" "}
            <Link
              className="text-blue-500"
              href="https://jadavpuruniversity.in/academics/mathematics/"
              target="_blank"
            >
              Jadavpur University
            </Link>{" "}
      ...
      <div className="mt-20 mb-10 text-xs md:text-sm">
        ...
        <Link
          className="text-blue-500"
          href="https://commons.wikimedia.org/wiki/File:Trefoil_Knot.gif"
        >
          Philip Rideout
        </Link>
        ,
